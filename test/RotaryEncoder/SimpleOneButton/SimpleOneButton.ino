 ...
 * Connect a pushbutton to pin 0 (ButtonPin) and ground.
...
void setup() {
  ...
  button.attachLongPressStart(holdHandler);
} // setup
...
// this function will be called when the button was pressed once.
void clickHandler() {
